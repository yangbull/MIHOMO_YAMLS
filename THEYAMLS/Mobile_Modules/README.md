...
#### 📝 config.yaml
- **路径**: `AkashaProxy/config.yaml` | **大小**: 32.6 KB | [查看源码](https://github.com/yangbull/MIHOMO_YAMLS/blob/main/THEYAMLS/Mobile_Modules/AkashaProxy/config.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
...
#### 📝 config.yaml
- **路径**: `Surfing/config.yaml` | **大小**: 18.9 KB | [查看源码](https://github.com/yangbull/MIHOMO_YAMLS/blob/main/THEYAMLS/Mobile_Modules/Surfing/config.yaml)
- **模式**: Rule | **TUN**: 🚫 | **IPv6**: ✅
<details>
